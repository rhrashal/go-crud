# Basic CRUD API written in Golang using Gin, GORM, PostgreSQL and gRpc
...
```bash
git clone https://github.com/rhrashal/go-crud.git
cd go-crud
```
...
- GitHub: [rhrashal](https://github.com/rhrashal)
